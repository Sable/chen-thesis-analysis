// Parsing time (ms): 0.66
 // - #: 3
// Total # of fused stmts: 3
static I horse_main(V *h_rtn);
static I q20_patternindex_1(V *z, V *x, V y);
static I q20_patterncompress_6(V *z, V x, V *y);
static I q20_autofusion_5(V z, V *x);
static I q20_patterncompress_7(V *z, V x, V *y);
static I q20_peephole_fp1_0(V z, V x, V y);
static I q20_patternindex_2(V *z, V *x, V y);
static I q20_patterncompress_8(V *z, V x, V *y);
static I q20_patternindex_3(V *z, V *x, V y);
...
static I horse_main(V *h_rtn){
    ...
    PROFILE(17, q20_patternindex_1((V []){t26, t27, t28}, (V []){t11, t12, t13}, t21));
    ...
    PROFILE(31, q20_patterncompress_6((V []){t69, t71, t72}, t67, (V []){t68, t70, t63}));
    ...
    PROFILE(39, q20_autofusion_5(t130, (V[]){t122}));
    PROFILE(42, q20_patterncompress_7((V []){t132, t133, t135}, t130, (V []){t113, t114, t116}));
    ...
    PROFILE(51, q20_patternindex_2((V []){t154, t155}, (V []){t133, t132}, t149));
    ...
    PROFILE(60, q20_patterncompress_8((V []){t179, t180}, t172, (V []){t27, t28}));
    PROFILE(61, pfnList(t185, 1, (V []){t179}));
    PROFILE(62, pfnOrderBy(t186, t185, LiteralBool(1)));
    PROFILE(64, q20_patternindex_3((V []){t187, t188}, (V []){t179, t180}, t186));
