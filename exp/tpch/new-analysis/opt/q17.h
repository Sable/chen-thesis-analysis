// Parsing time (ms): 0.566
 // - #: 2
 // - #: 4
 // - #: 3
// Total # of fused stmts: 9
static I horse_main(V *h_rtn);
static I q17_autofusion_6(V z, V *x);
static I q17_patternindex_0(V *z, V *x, V y);
static I q17_autofusion_5(V z, V *x);
static I q17_autofusion_4(V z, V *x);

static I q17_autofusion_6(V z, V *x){
    V x0=x[0]; // t7
    V x1=x[1]; // t4
    Q id0=getSymbol("MED BOX");
    Q id1=getSymbol("Brand#23");
    L r0=vn(x1);
    /* Fusion: kind E */
    initV(z, H_B, r0);
    DOP(r0, vB(z,i)=AND(EQ(vQ(x0,i),id0),EQ(vQ(x1,i),id1))) R 0;
}
static I q17_patternindex_0(V *z, V *x, V y){
    V z0 = z[0]; // t56
    V z1 = z[1]; // t57
...
static I q17_autofusion_5(V z, V *x){
    ...
    /* Fusion: kind E */
    initV(z, H_E, r0);
    DOP(r0, vE(z,i)=MUL(0.2,DIV(MUL(vL(x0,i),vE(x1,i)),MUL(vL(x0,i),vL(x2,i))))) R 0;
}
static I q17_autofusion_4(V z, V *x){
    V x0=x[0]; // t57
    V x1=x[1]; // t115
    ...
    E c = 0; L tot=0;
    initV(z, H_E, 1);
    DOP(r0, c+=vE(x0, vL(x1,i)), reduction(+:c))
    vE(z,0) = c;
    R 0;
}
...
static I horse_main(V *h_rtn){
    ...
    PROFILE(10, q17_autofusion_6(t12, (V[]){t7,t4}));
    ...
    PROFILE(21, q17_patternindex_0((V []){t56, t57}, (V []){t27, t28}, t41));
    ...
    PROFILE(49, q17_autofusion_5(t111, (V[]){t101,t105,t108}));
    ...
    PROFILE(55, q17_autofusion_4(t147, (V[]){t57,t115}));
