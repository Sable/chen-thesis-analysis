...
static I q4_autofusion_4(V z, V *x){
    ...
    /* Fusion: kind E */
    initV(z, H_B, r0);
    DOP(r0, vB(z,i)=AND(AND(GEQ(vD(x0,i),19930701),LT(vD(x0,i),19931001)),vB(x1,i))) R 0;
}
static I q4_patternindex_1(V *z, V *x, V y){
    V z0 = z[0]; // t84
    V z1 = z[1]; // t85
...
static I horse_main(V *h_rtn){
    ...
    PROFILE(21, q4_autofusion_4(t64, (V[]){t6,t63}));
    ...
    PROFILE(34, q4_patternindex_1((V []){t84, t85}, (V []){t78, t81}, t83));
