// Parsing time (ms): 0.52
static I horse_main(V *h_rtn);
static I q15_patterncompress_1(V *z, V x, V *y);
...
static I horse_main(V *h_rtn){
    ...
    PROFILE(9, pfnGeq(t17, t11, LiteralDate(19960101)));
    PROFILE(10, pfnLt(t18, t11, LiteralDate(19960401)));
    PROFILE(11, pfnAnd(t19, t17, t18));
    PROFILE(14, q15_patterncompress_1((V []){t22, t25, t26}, t19, (V []){t3, t6, t7}));
    PROFILE(15, pfnMinus(t36, LiteralI32(1), t26));
    PROFILE(16, pfnMul(t37, t25, t36));
