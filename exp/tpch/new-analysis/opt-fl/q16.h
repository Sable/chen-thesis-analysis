// Parsing time (ms): 0.549
 // - #: 2
 // - #: 4
// Total # of fused stmts: 6
static I horse_main(V *h_rtn);
static I q16_autofusion_3(V z, V *x);
static I q16_autofusion_1(V z, V *x);
...
static I horse_main(V *h_rtn){
    ...
    PROFILE(19, q16_autofusion_3(t32, (V[]){t27,t20,t29}));
    ...
    PROFILE(31, q16_autofusion_1(t64, (V[]){t63,t49}));
