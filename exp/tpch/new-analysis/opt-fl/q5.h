// Parsing time (ms): 0.788
 // - #: 2
 // - #: 3
// Total # of fused stmts: 5
static I horse_main(V *h_rtn);
static I q5_autofusion_4(V z, V *x);
static I q5_autofusion_3(V z, V *x);
...
static I horse_main(V *h_rtn){
    ...
    PROFILE(36, q5_autofusion_4(t73, (V[]){t66}));
    PROFILE(37, pfnCompress(t74, t73, t62));
    PROFILE(38, pfnFetch(t75, t63));
    PROFILE(39, pfnCompress(t83, t73, t75));
    ...
    PROFILE(73, q5_autofusion_3(t226, (V[]){t214,t215}));
    ...
    PROFILE(79, pfnEachRight(t232, t226, t230, pfnIndex));
    PROFILE(80, pfnEach(t233, t232, pfnSum));
    PROFILE(81, pfnRaze(t234, t233));
