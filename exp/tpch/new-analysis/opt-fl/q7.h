// Parsing time (ms): 1.105
 // - #: 2
 // - #: 3
// Total # of fused stmts: 5
static I horse_main(V *h_rtn);
static I q7_autofusion_4(V z, V *x);
static I q7_autofusion_3(V z, V *x);
...
static I horse_main(V *h_rtn){
    ...
    PROFILE(65, q7_autofusion_4(t133, (V[]){t125}));
    ...
    PROFILE(96, q7_autofusion_3(t251, (V[]){t238,t239}));
